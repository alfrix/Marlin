...
#define STRING_CONFIG_H_AUTHOR "(alfrix)" // Who made the changes.
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 240, 240, 12, 80 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 800, 400, 5000 }
 ...
 *   JD=0.4*((DEFAULT_XJERK*DEFAULT_YJERK)/DEFAULT_ACCELERATION))
 */
...
#define Z_AFTER_HOMING  0.28         // (mm) Height to move to after homing Z
...
// I´m not needing more resolution than this for now 0-25-50-75-100
